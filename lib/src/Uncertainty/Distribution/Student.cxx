...
Student::Student(const Scalar nu,
  ...
  : EllipticalDistribution(Point(dimension, 0.0),
                           Point(dimension, 1.0),
                           CorrelationMatrix(MatrixImplementation::identityMatrix(dimension)),
                           -1.0)
  , nu_(0.0)
...
Student::Student(const Scalar nu,
                 const Scalar mu,
                 const Scalar sigma)
  : EllipticalDistribution(Point(1, mu), Point(1, sigma), CorrelationMatrix(MatrixImplementation::identityMatrix(1)), -1.0)
  , nu_(0.0)
  , studentNormalizationFactor_(0.0)
{
  setName("Student");
